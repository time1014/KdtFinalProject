...
CREATE TABLE commit_logs (commit_id VARCHAR2(50) PRIMARY KEY, repository_id VARCHAR2(50) NOT NULL REFERENCES repository_setting(repository_id) ON DELETE CASCADE, commit_hash VARCHAR2(100), commit_user VARCHAR2(50), commit_message CLOB, committed_at DATE, task_id VARCHAR2(50));
